...
- **Insurance Management**: SBC document upload (Claude AI extraction), plan comparison, benefit search
...
4. **AI is educational** - Claude responses are informational, not diagnostic
