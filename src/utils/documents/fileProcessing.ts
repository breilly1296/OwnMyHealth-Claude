...
// Re-export PDF extraction from documentParser for backwards compatibility
export { extractTextFromDocument as extractTextFromPDF } from './documentParser';
...
export async function processClinicalFile(file: File): Promise<ProcessingResult> {
  ...
  try {
    // Use shared text extraction function
