...
import { Database, Search, Filter, BarChart3, TrendingUp, Shield, DollarSign, CheckCircle, XCircle, AlertCircle, Eye, GitCompare as Compare, Tag, Network, FileText, Brain, Target, Zap } from 'lucide-react';
...
import { 
  ...
  type PlanComparison
} from '../utils/insuranceKnowledgeBase';
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setSearchCriteria(prev => ({
                        ...prev,
                        preferredPlanTypes: Array.from(e.target.selectedOptions, option => option.value) as any
                      }))}
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setSearchCriteria(prev => ({
                        ...prev,
                        expectedUsage: e.target.value as any
                      }))}
                      className="w-full border border-gray-300 rounded-md shadow-sm p-2"
                    >
