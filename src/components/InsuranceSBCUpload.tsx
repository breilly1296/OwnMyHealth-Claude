...
import { Upload, X, FileText, Shield, DollarSign, Loader2, CheckCircle, AlertCircle, Eye, Download } from 'lucide-react';
import type { InsurancePlan, SBCProcessingResult } from '../types';
import { processSBCFile, getKeyPlanFeatures, formatCoverageDisplay } from '../utils/sbcParser';
