/**
 * InsuranceEducationPanel (InsuranceGuide) Component
 *
 * An educational panel providing personalized insurance guidance based on the user's
 * health profile and insurance plans. Helps users understand their coverage and
 * find opportunities to save money.
 *
 * Collapsible sections include:
 * 1. Your Health Profile - Detected conditions and recommended services based on biomarkers
 * 2. Your Cost Projections - Estimated annual costs broken down by scenario (premiums, OOP, medical)
 * 3. Insurance Education - Interactive modules with terms, definitions, and real-world scenarios
 *    showing cost breakdowns, key learnings, and action items
 * 4. Money-Saving Tips - Optimization tips with difficulty ratings, time to implement,
 *    and potential savings amounts
 * 5. Insurance Terms Glossary - Quick reference for common insurance terminology
 *
...
import type { PersonalizedInsuranceGuide } from '../../types';
import { formatCurrency } from '../../utils/insurance/insuranceEducation';
